...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Lokasi /</span> Edit Lokasi</h4>
<div class="card mb-4">
        ...
        <form action="{{ route('lokasi.update', $location->id) }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" id="address" name="address" rows="3" required>{{ $location->address }}</textarea>
                </div>
